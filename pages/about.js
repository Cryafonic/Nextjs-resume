  ...
  return (
    <>
      ...
      <div>
        ...
        <p>
          Duty: Providing customer and technical support for the software that
          is being built by Orderwise.
        </p>
      </div>
      <div>
        ...
        <p>
          Duty: Form repairing customers computers/laptop to throubleshooting
          the ISP faults.
        </p>
      </div>
      <div>
      ...
      <h1>Education</h1>
      <div>
        <p>Institution: HyperionDev</p>
        <p>Qualification: Certification</p>
        <p>Start date: 11 Jan 2021 End-date: 11 Jan 2021</p>
