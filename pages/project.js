  ...
  return (
    <>
      ...
      >
        ...
        <div className="carousel-inner">
          <div className="carousel-item active">
            <a href="https://github.com/Cryafonic/React-resume">
              <Image
                src={reactResume}
            ...
            <div className="carousel-caption d-none d-md-block">
              ...
              <p className="text-muted">
                Code: HTML5, CSS3,javascript with the reactjs library
              </p>
              <p className="text-muted">Resume that was build with Reactjs</p>
            </div>
          </div>
          <div className="carousel-item">
            <a href="https://github.com/Cryafonic/React-Minesweeper">
              <Image
                src={reactMinesweeper}
                className="d-block w-100"
            ...
            <div className="carousel-caption d-none d-md-block">
              ...
              <p className="text-muted">
                Code: JSX, CSS3, Sass, JavaScript with the Reactjs Library
              </p>
              <p className="text-muted">
                Minesweeper that was build with Reactjs
              </p>
            </div>
          </div>
          <div className="carousel-item">
            <a href="https://github.com/Cryafonic/ItunesSearch">
              <Image
                src={iTunesSearch}
                className="d-block w-100"
                alt="iTunes-search"
            ...
            <div className="carousel-caption d-none d-md-block">
              ...
              <p className="text-muted">
                Code: JSX, CSS3, JavaScript with the Reactjs and nodejs
                Libraries
              </p>
              <p className="text-muted">
                iTunes search app that was build with Reactjs and nodejs
              </p>
            </div>
          </div>
        </div>
      ...
      <div>
        ...
        <p>
          The second slide is the on we all love. A old one but still the best
          game ever made. Minesweeper.
        </p>
        ...
        <p>
          Itunes search app is very basic in its search parameters with a
          minimalistic look. As you can see in slide three. <br />
          Its is capabale of search anything on the iTunes store including
          books, music, podcasts etc.The iTunes stores backend is build with the
