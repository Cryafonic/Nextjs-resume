    ...
    <>
      <div>
        ...
        <span className="summary">
          <p>
            I have a pleasant, friendly personality and enjoy challenges.
            Honesty, dedication, and loyalty are some of my strong points. I am
            a hard worker and a fast learner. I believe in code ethics and
            solving issues efficiently. It&apos;s a feature, not a bug. Learning
            new things every day is the main reason why I decided to pursue a
        ...
        <span>
          ...
          <div className="images">
            <span>
              <Image src={html5} alt="HTML5" width={200} height={200} />
              <h2>HTML5</h2>
              <p>+-1 year</p>
            </span>
            <span>
              <Image src={css3} alt="CSS3" width={200} height={200} />
              <h2>CSS3</h2>
              <p>+-1 year</p>
            </span>
            <span>
            ...
            <span>
              <Image src={react} alt="Reactjs" width={200} height={200} />
              <h2>Reactjs</h2>
              <p>+-1 year</p>
            </span>
            <span>
              <Image src={jest} alt="Jestjs" width={200} height={200} />
              <h2>Jestjs</h2>
              <p>+-1 year</p>
            </span>
            <span>
              <Image src={express} alt="Expressjs" width={200} height={200} />
              <h2>Expressjs</h2>
              <p>+-1 year</p>
            </span>
            <span>
              <Image src={node} alt="Nodejs" width={200} height={200} />
              <h2>Nodejs</h2>
              <p>+-1 year</p>
            </span>
            <span>
            ...
            <span>
              <Image src={jquery} alt="jQuery" width={200} height={200} />
              <h2>jQuery</h2>
              <p>+-1 year</p>
            </span>
            <span>
